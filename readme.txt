...
LOGIN PAGE FOR ADMIN, PATIENT, DOCTOR, RECEPTIONIST
   ...
   - For giving link to login button use LINK tag for this 
       - in app.js we will need to make link over there and from there the url we use there we need to use that over button using LINK tag